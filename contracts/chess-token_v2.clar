...
;; Updated for Clarity 4 - gateway-release replaces as-contract
;; ============================================================
...
(define-constant FAUCET-COOLDOWN u144)
...
;; -------------------------------------------------------
;; Gateway Release - Clarity 4 replacement for as-contract
;;
;; Only callable by .gateway (checked via contract-caller).
;; Uses ft-transfer? which is a privileged primitive inside
;; this contract - no as-contract needed.
;; Tokens flow: .chess-token vault -> recipient
;; -------------------------------------------------------
...
;; -------------------------------------------------------
;; Read: Contract vault balance (tokens held in escrow)
;; -------------------------------------------------------
