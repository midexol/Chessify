...
function RookPiece() {
  return (
    <svg viewBox="0 0 80 140" width="100%">
      ...
      <div style={{position:'relative',minHeight:'calc(100vh - 76px)',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',textAlign_:'center',padding:'60px 48px 80px'}}>
      ...
      {/* Scroll */}
      <div style={{textAlign_:'center',paddingBottom:36,display:'flex',flexDirection:'column',alignItems:'center',gap:8,position:'relative',zIndex:4}}>
