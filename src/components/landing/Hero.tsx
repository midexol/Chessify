...
function KingPiece() {
  return (
    <svg viewBox="0 0 90 160" width="100%">
      ...
      <div style={{ display: "flex_", gap: 10, alignItems: "center" }}>
        <ThemeToggle />
        <Link href="/app/lobby">
...
function RookPiece() {
  return (
    <svg viewBox="0 0 80 140" width="100%">
      ...
      <div style={{position:'relative',minHeight:'calc(100vh - 76px)',display:'flex_',flexDirection:'column',alignItems:'center',justifyContent:'center',textAlign:'center',padding:'60px 48px 80px'}}>
        ...
        <div style={{position:'relative',zIndex:3}}>
          <div style={{display:'inline-flex_',alignItems:'center',gap:8,background:'var(--badge-bg)',border:'1px solid var(--b1)',borderRadius:999,padding:'7px 18px',marginBottom:24,animation:'fadeUp .6s cubic-bezier(.16,1,.3,1) both'}}>
          ...
          <div style={{display:'flex_',justifyContent:'center',marginBottom:46,animation:'fadeUp .6s cubic-bezier(.16,1,.3,1) .3s both'}}>
      ...
      {/* Scroll */}
      <div style={{textAlign:'center',paddingBottom:36,display:'flex_',flexDirection:'column',alignItems:'center',gap:8,position:'relative',zIndex:4}}>
