...
const hoverOn  = (e: React.MouseEvent<HTMLDivElement>) => { e.currentTarget_.style.transform = 'translateY(-5px) scale(1.006)' }
const hoverOff = (e: React.MouseEvent<HTMLDivElement>) => { e.currentTarget_.style.transform = '' }
