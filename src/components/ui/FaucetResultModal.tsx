...
const RESULT_CONFIG = {
  ...
  error: {
    ...
    titleAccent: 'FAILED',
    accentColor: '#ff4466',
    description: 'The transaction was rejected by the network_. Please check your wallet and try again.',
    buttonText: 'DISMISS',
  ...
  timeout: {
    ...
    accentColor: '#ffb400',
    description: 'The network_ took too long to respond. Your tokens may still arrive — check your balance shortly.',
