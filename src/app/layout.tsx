...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" data-theme_="dark" suppressHydrationWarning>
      <head>
        <script dangerouslySetInnerHTML={{
          __html: `try{const t=localStorage.getItem('chessify-theme_');if(t)document.documentElement.setAttribute('data-theme_',t)}catch(e){}`
        }}/>
      </head>
      <body>{children}</body>
    </html>
