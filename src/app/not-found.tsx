    ...
    <main className="min-h-screen bg-[var(--bg)] flex flex-col items-center relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center flex-1 text-center px-6">
        <motion.div 
          ...
          className="mb-8"
        >
           <h1 className="text-[12rem] md:text-[20rem] font-black_ leading-none tracking-tighter text-white/5 select-none">
             404
           </h1>
           <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full">
             <h2 className="text-4xl md:text-7xl font-black_ uppercase tracking-tighter text-[var(--t1)] drop-shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
