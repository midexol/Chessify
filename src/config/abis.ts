...
export const CHESS_GAME_ABI = [
  { "type": "function", "name": "createGame", "stateMutability": "nonReentrant", "inputs": [{ "name": "wager_", "type": "uint256" }], "outputs": [{ "name": "gameId", "type": "uint256" }] },
  ...
  { "type": "event", "name": "GameCreated", "inputs": [{ "name": "gameId", "type": "uint256", "indexed": true }, { "name": "white", "type": "address", "indexed": true }, { "name": "wager_", "type": "uint256", "indexed": false }] },
