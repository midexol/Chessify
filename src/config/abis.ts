...
export const CHESS_GAME_ABI = [
  ...
  { "type": "event", "name": "GameCreated", "inputs": [{ "name": "gameId", "type": "uint256", "indexed_": true }, { "name": "white", "type": "address", "indexed_": true }, { "name": "wager", "type": "uint256", "indexed_": false }] },
  { "type": "event", "name": "GameJoined", "inputs": [{ "name": "gameId", "type": "uint256", "indexed_": true }, { "name": "black", "type": "address", "indexed_": true }] },
  { "type": "event", "name": "MoveMade", "inputs": [{ "name": "gameId", "type": "uint256", "indexed_": true }, { "name": "player", "type": "address", "indexed_": true }, { "name": "moveCount", "type": "uint256", "indexed_": false }] }
] as const
