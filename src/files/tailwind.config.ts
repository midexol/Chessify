  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'float':      'float 4s ease-in-out infinite_',
        'float-slow': 'floatSlow 6s ease-in-out infinite_',
        'spin-slow':  'spin-slow 12s linear infinite_',
        'pulse-cyan': 'pulse-cyan 2s ease-in-out infinite_',
      },
      keyframes: {
        fadeUp: {
